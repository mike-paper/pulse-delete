...
def push(d):
    ...
    print('got push df len:', len(df), flush = True)
    print('got push df:', df.head(3), flush = True)
    ...
    note = f'Paper Metrics updated {len(df)} rows at {lastRunDt}\n\nMore info at https://www.trypaper.io/'
